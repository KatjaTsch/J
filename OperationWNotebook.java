...
public class OperationWNotebook {
    ...
    public OperationWNotebook(Set<Notebooks> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public OperationWNotebook(Set<Notebooks> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
